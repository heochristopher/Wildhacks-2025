    ...
    return (
      <>
        {/*
          ...
          ```
        */}
        <div className="flex min-h-full font-mono h-screen bg-white flex-1 flex-col justify-center px-6 py-12 lg:px-8">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    type="firstname"
                    required
                    className="block w-full rounded-md border-0 bg-black/5 py-1.5 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-green-900 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
